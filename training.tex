...
\begin{exercise}
  ...
  Also try making simple documents with \textsf{memoir} and \textsf{beamer}:
  see how without any other changes, the entire appearance of the PDF
  file is altered.
\end{exercise}
