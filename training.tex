...
\begin{frame}[fragile]{Commands and arguments}

  \begin{block}{Syntax}
    \begin{semiverbatim}
\\command
\\command\{\meta{argument}\}
\\command[\meta{argument}]
\\command[\meta{argument1}]\{\meta{argument2}\}
    \end{semiverbatim}
  \end{block}
...
\\emph\{\meta{text}\}
\\lipsum[\meta{number}]
\\section[\meta{short-title}]\{\meta{long-title}\}
    \end{semiverbatim}
  \end{block}
...
\tutornote{Finish exercise at 11:00}
...
\tutornote{Finish exercise at 12:00}
...
\tutornote{Finish exercise at around 13:45}
...
\begin{frame}{Working with long documents}
  ...
  \begin{itemize}
    ...
    \item \cs{include} is used for separate chapters:\\ it always starts
      a new page;
    \item Using \cs{include} allows you to \cs{includeonly} single chapters.
  \end{itemize}
...
\tutornote{Finish exercise at 16:15}
